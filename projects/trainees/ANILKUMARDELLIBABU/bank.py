...
def send_email_alert(subject, message, to_email):
    ...
    from_email = 'dubaanilkumar99@gmail.com'   # Sender email
    password = 'xdxk sxfr ynle tgap'             # Replace with sender email password (use an app password if using Gmail)
    ...
    try:
        ...
        server.sendmail(from_email, to_email, msg = "Anil kumar for bank management") # Corrected line for sending the email
...
def run_concurrent_tasks():
    ...
    t2 = threading.Thread(target=send_email_alert, args=(
        ...
        'Hello Anil, your account balance has been updated.',  
        'dubaanilkumar99@gmail.com'))
...
create_database()
add_account("Anil kumar's Account", 1000.0)
